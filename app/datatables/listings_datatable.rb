...
private
  ...
  def sort_column
    columns = %w[id name checked menu_state menu_source keep notes 
       telephone fax suite address city province postal_code 
      latitude longitude business_type sub_type owner local_area ]
